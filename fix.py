...
# Fix physical newlines inside EpubReaderActivity.cpp strings
with open('src/activities/reader/EpubReaderActivity.cpp', 'r', encoding='utf-8') as f:
    content = f.read()
...
with open('src/activities/reader/EpubReaderActivity.cpp', 'w', encoding='utf-8', newline='\n') as f:
    f.write(content)
print("[*] Formatted src/activities/reader/EpubReaderActivity.cpp")
